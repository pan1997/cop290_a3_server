    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user == null)
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT Complaints.*,Users.first_name,Users.last_name FROM Complaints INNER JOIN Users ON Complaints.user_id = Users.user_id WHERE level=2" + (st != null ? " AND Complaints.status=" + st : ""));
